...
export interface ApiContenidoContenido extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    unidad: Schema.Attribute.Relation<'oneToOne', 'api::unidad.unidad'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiMateriaMateria extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    unidads: Schema.Attribute.Relation<'oneToMany', 'api::unidad.unidad'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiUnidadUnidad extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    materia: Schema.Attribute.Relation<'oneToOne', 'api::materia.materia'>;
    nombre: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;

'use client'; import { useState, useEffect, styled, apiRest, toast, gestorCookie, Link, textBarHeader } from '@/app/utils/hooks';
...
export default function DashboardPage() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const response = await apiRest.fetchGet('http://localhost:3333/ovacademy/user/show');

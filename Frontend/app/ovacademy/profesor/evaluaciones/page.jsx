				...
				<div className="tab-content">
					{activeTab === 0 && (
						<div className="tab-panel">
							<WrapperTitleRegister tittle={"📘 Registrar Evaluaciones"} 
							subtittle={" A continuación registra una evaluación relacionada a una unidad"} 
							ContentComponent={() => <CrearEvaluaciones TabClick={TabClick} />} />
						</div>
					)}

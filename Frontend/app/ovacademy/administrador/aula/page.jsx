'use client'; import { useState, styled, CrearAula, AsignarAulaSemestre, useEffect, Link, textBarHeader} from '@/app/components/utils/rutas';
            ...
            <div className="tab-content">
              ...
              {activeTab === 0 && (
                <div className="tab-panel">
                  ...
                  <p>
                    Completa el siguiente formulario para registrar uan nueva sección
                  </p>
                  <CrearAula setActiveTab={setActiveTab}/>
                </div>
              )}

import { useEffect, useState, Link, styled, gestorCookie  } from '@/app/components/utils/rutas';

import { IoMdLogOut } from "react-icons/io";
import { MdEdit } from "react-icons/md";


export default function Nav_user({ handleClick, userAuth}) {
                ...
                <div className="user-menu-details-bottom-wrapper center">
                    ...
                    <div className="pt-05 pr-05">
                        {userAuth === 'administrador' && (
                            <Link href="/ovacademy/administrador/profile" passHref>
                        ...
                        {userAuth === 'profesor' && (
                            <Link href="/ovacademy/profesor/profile" passHref>
                                <button className="icon icon-edit">
                                    <MdEdit />
                                </button>
                            </Link>
                        ...
                        {userAuth === 'estudiante' && (
                            <Link href="/ovacademy/estudiante/profile" passHref>
                                <button className="icon icon-edit">
                                    <MdEdit />
                                </button>
                            </Link>
